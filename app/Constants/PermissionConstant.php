...
class PermissionConstant
{
    const LIST = [
        ...
        ['label' => 'Delete Review ', 'name' => 'delete-review', 'group' => 'review'],
        ['label' => 'Update Review ', 'name' => 'update-review', 'group' => 'review'],
        ['label' => 'Create Review ', 'name' => 'create-review', 'group' => 'review'],
        ['label' => 'View Review ', 'name' => 'view-review', 'group' => 'review'],

        ['label' => 'Delete Discount ', 'name' => 'delete-discount', 'group' => 'discount'],
        ['label' => 'Update Discount ', 'name' => 'update-discount', 'group' => 'discount'],
        ['label' => 'Create Discount ', 'name' => 'create-discount', 'group' => 'discount'],
        ['label' => 'View Discount ', 'name' => 'view-discount', 'group' => 'discount'],
