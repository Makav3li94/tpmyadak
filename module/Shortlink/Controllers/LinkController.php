...
class LinkController extends Controller
{
    public function index(Request $request)
    {
        ...
        return inertia('admin/shortlink/index', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.shortlink.link.index')
            ->with('message', ['type' => 'success', 'message' => 'لینک با موفقیت ایجاد شد.']);
    }
    ...
    public function show(Request $request, Link $link)
    {
        ...
        return inertia('admin/shortlink/show', [
            'link' => $link,
    ...
    public function update(Request $request, Link $link)
    {
        ...
        return redirect()->route('admin.shortlink.link.index')
            ->with('message', ['type' => 'success', 'message' => 'لینک با موفقیت ویرایش شد.']);
    }
    ...
    public function destroy(Link $link)
    {
        ...
        return redirect()->route('admin.shortlink.link.index')
            ->with('message', ['type' => 'success', 'message' => 'لینک با موفقیت حذف شد.']);
    }
}
