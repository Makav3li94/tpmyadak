...
const navigation = [
    ...
    {name: 'سفارش ها', href: route('user.orders'), icon: BringToFront, current: true},
    {name: 'تراکنش ها', href: route('user.transactions'), icon: SaudiRiyal, current: true},
    {name: 'لیست خرید', href: route('user.wishlists'), icon: ListOrdered, current: true},
    {name: 'تیکت ها', href: route('user.tickets'), icon: TicketCheck, current: true},
    {name: 'اعلان ها', href: route('user.notifications'), icon: Megaphone, current: true},
]
