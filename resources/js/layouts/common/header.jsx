                ...
                <div className="grid grid-cols-12 py-6 items-center">
                    <div className="hidden lg:flex lg:col-span-4">
                        ...
                        >
                            ...
                            <span className="text-[#282828] tracking-[0.5px] px-3 py-2">
                  سبد خرید
                </span>
                  ...
                  ۲۸۸,۰۰۰ تومان
                            ...
                            <div
                                className="hidden border-1 border-gray-300 group-hover:block w-[180%] absolute top-full right-2 translate-x-2 z-50 mt-1 py-2 bg-white">
                                <div
                                    className="flex items-center text-gray-600 justify-between pt-3 pb-4 border-b border-gray-300 px-3">
                                    <a href="#" title="product01">
                                        <img src="./image/selectedproduct02.jpg" alt="محصول انتخابی" className="w-[52px] h-[52px]"/>
                                    </a>
                                    <span className="text-sm text-gray-500 hover:text-[#ff2d37] transition duration-300 ease-in pr-2 pl-3">
                      تایر درجه یک خارجی
                    </span>
                                    <span className="text-gray-500 px-2">x۱</span>
                      ...
                      ۵۰۰,۰۰۰ تومان
                                    ...
                                    <svg
                                        ...
                                        width="14px"
                                        fill="#b1b5bb"
                                        className="hover:fill-[#ff2d37] transition duration-300 ease-in"
                                    >
                                        <path
                                    ...
                                    <svg
                                        ...
                                        width="18px"
                                        fill="#b1b5bb"
                                        className="hover:fill-[#ff2d37] ml-0 mr-auto transition duration-300 ease-in"
                                    >
                                        <path
                                ...
                                <div
                                    ...
                                    <span
                                        className="text-sm text-gray-500 hover:text-[#ff2d37] transition duration-300 ease-in pr-2 pl-3">
                      جعبه فرمان اورجینال{" "}
                    </span>
                                    <span className="text-gray-500 px-2">x۱</span>
                                    <span className="text-gray-500 pr-2 pl-5  ">
                    ...
                    <span className="font-extrabold text-[14px] text-gray-600">
                      جمع جز
                                    ...
                                    <span className="text-gray-500">۱,۳۰۰،۰۰۰ تومان</span>
                                </div>
                                <div className="flex justify-between px-3 py-2 border-b border-gray-300">
                    <span className="font-extrabold text-[14px] text-gray-600">
                      تخفیف
                    ...
                    <span className="font-extrabold text-[14px] text-gray-600">
                      جمع کل
                                ...
                                <div className="flex justify-between px-3 py-2">
                                    ...
                                    >
                      <span className="text-base hover:text-[#ff2d37]">
                        مشاهده سبد
                      </span>
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            width="16px"
                                            fill="#9ca3af"
                                            className="group-hover:fill-[#ff2d37]"
                                        >
                                            <path
                      ...
                      <span className="text-base hover:text-[#ff2d37]">
                        ...
                        <a
                            href="#"
                            title="favourite"
                            className="hidden xl:block items-center border-[1.5px] border-gray-300 rounded-md p-2 xl:mr-6 group"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 640 640"
                                fill="#282828"
                                width="24px"
                                className="group-hover:fill-[#ff2d37] transition duration-300 ease-in"
                            >
                                <path
                    ...
                    <div className="searchForm hidden lg:flex lg:col-span-6 lg:pl-6">
                        <form className="w-full mx-auto">
                            <div className="flex">
                                ...
                                >
                                    کلمه کلیدی خود را بنویسید{" "}
                                </label>
                                <button
                                    id="dropdown-button"
                                    data-dropdown-toggle="dropdown"
                                    className="shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600 cursor-pointer"
                                    type="button"
                                >
                                    دسته بندی ها{" "}
                                    <svg
                                ...
                                <div className="relative w-full">
                                    <input
                                        type="search"
                                        id="search-dropdown"
                                        className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-gray-300 focus:border-gray-300 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400"
                    ...
                    {/* ------------- logo ----------------- */}
                    <Link href={route('home')} className="w-[150px] sm:w-[200px] flex col-span-12 lg:col-span-2 h-auto   text-left ">
