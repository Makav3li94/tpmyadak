...
export default function Home(props) {
    ...
    const onDelete = () => {
        if (confirmModal.data !== null) {
            router.delete(route('admin.filters.destroy', confirmModal.data.id))
        }
    }
    ...
    return (
        <AuthenticatedLayout
            ...
            breadcumbs={[
                ...
                { name: 'فیلتر', href: route('admin.filters.index') },
            ]}
        >
            <Head title="فیلتر" />
