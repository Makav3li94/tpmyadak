...
export default function FormModal(props) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        const tax = modalState.data
        if (tax !== null) {
            put(route('admin.taxes.update', tax), {
    ...
    useEffect(() => {
        const tax = modalState.data
        if (isEmpty(tax) === false) {
            setData(tax)
        }
    }, [modalState])

    return (
        <Modal isOpen={modalState.isOpen} onClose={handleClose} title={'افزودن/ویرایش مالیات'}>
