...
export default function Home(props) {
    ...
    const toggleFormModal = (carModel = null) => {
        formModal.setData(carModel)
        formModal.toggle()
    }

    const handleDeleteClick = (carModel) => {
        confirmModal.setData(carModel)
        confirmModal.toggle()
    }

    const onDelete = () => {
        if (confirmModal.data !== null) {
            router.delete(route('admin.car.models.destroy', confirmModal.data.id))
        }
    }
    ...
    return (
        <AuthenticatedLayout
            ...
            breadcumbs={[
                ...
                { name: 'مدل خودرو', href: route('admin.car.models.index') },
            ]}
        >
            <Head title="مدل خودرو" />
                            ...
                            <tbody>
                                {data.map((carModel, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>{carModel.car_brand.title}</td>
                                        <td>{carModel.slug}</td>
