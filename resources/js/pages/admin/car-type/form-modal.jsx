...
export default function FormModal(props) {
    ...
    const handleSubmit = (e) => {
        ...
        if (carModel !== null) {
            put(route('admin.car.types.update', carModel), {
                onSuccess: () => handleClose(),
            })
            return
        }
        post(route('admin.car.types.store'), {
            onSuccess: () => handleClose(),
        })
    }
    ...
    return (
        <Modal isOpen={modalState.isOpen} onClose={handleClose} title={'افزودن/ویرایش تایپ خودرو'}>
                        ...
                        <SelectModalInput
                            ...
                            onChange={(item) =>
                                setData({
                                    ...data,
                                    car_model: item,
                                    car_model_id: item ? item.id : null,
                                })
                            }
                            onRemove={() =>
                                setData({...data, car_model: '', car_model_id: null})
                            }
